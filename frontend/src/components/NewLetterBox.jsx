...
function NewLetterBox() {
  ...
  return (
    <div className="w-[100%] h-[40vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-center justify-start gap-[10px] flex-col ">
       ...
       <p className='md:text-[30px] text-[20px] text-[#a5faf7] font-semibold px-[20px] '>Subscribe now & enjoy exclusive savings ,special deals ,and early access to new collections</p>
